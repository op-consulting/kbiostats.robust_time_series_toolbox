...
outfile=model.js
infile=model.nim
nim js -d:nodejs -d:release -d:in_production --stackTrace:off --lineTrace:off --threads:off --checks:off --objChecks:off --fieldChecks:off --rangeChecks:off --boundChecks:off --overflowChecks:off --assertions:off --floatChecks:off --nanChecks:off --infChecks:off --nilChecks:off --opt:size --out:$outfile $infile
...
echo "exports.existence_change_point_hypothesis = existence_change_point_hypothesis" >> $outfile
