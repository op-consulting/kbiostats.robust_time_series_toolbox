...
class BasicCanvasPlotter {
    ...
    create() {
        ...
        this.__chart = new Dygraph(this.__element,
            data, options);
        window.chart01 = this.__chart
    }
    create3() {
        this.__chart = Plotly.plot(this.__element, [{
            x: [1, 2, 3, 4, 5],
            y: [1, 2, 4, 8, 16] }], {
            margin: { t: 0 } } );
        window.chart01 = this.__chart
...
class PlotSnapshootTimeSeries extends BasicCanvasPlotter {
    constructor(model, element) {
        super(model, element);
    }
    get options() {
...
class PlotCollector {
    ...
    createChart(type_plot, unit_model){
        ...
        component.style.cssText = "width:100%!important; height: 100%!important; display: block";
