...
var NTI153632 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
var NTI153631 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
NTI153632.base = NTI124;
var NNI153631 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "autocorrelation", len: 0, typ: NTI153632, name: "autocorrelation", sons: null}, 
{kind: 1, offset: "confidence_interval", len: 0, typ: NTI124, name: "confidence_interval", sons: null}]};
NTI153631.node = NNI153631;
...
{kind: 1, offset: "autocorrelation_function", len: 0, typ: NTI153631, name: "autocorrelation_function", sons: null}, 
...
function vector_148236(v_148239) {
	var result_148240 = {length: 0, data: null};
		...
		result_148240.data = new Float32Array(1012);
...
function HEX2EHEX2A_152156(v_152158, w_152159) {
	var result_152160 = [{length: 0, data: null}];
		...
		result_152160[0].data = new Float32Array(1012);
		L1: do {
			var i_152177 = 0;
...
function HEX5BHEX5D_150414(v_150416, idx_150424) {
	var result_150425 = {length: 0, data: null};
		...
		result_150425.data = new Float32Array(1012);
		var k_150435 = 0;
		L1: do {
			var i_150474 = 0;
			L2: do {
...
function HEX2D_152028(v_152030, k_152031) {
	var result_152032 = [{length: 0, data: null}];
		...
		result_152032[0].data = new Float32Array(1012);
		L1: do {
			var i_152049 = 0;
...
function acf_153665(x_153667, max_lag_153668) {
	var result_153669 = [{length: 0, data: null}];

		result_153669[0].data = new Float32Array(1012);
		var n_153678 = high_148797(x_153667);
		var u_153679 = mean_153041(x_153667);
		var s2_153680 = variance_153076(x_153667);
		HEX5BHEX5DHEX3D_150014(result_153669[0], 0, 1.0000000000000000e+00);
		L1: do {
			var h_153693 = 0;
			var colontmp__153721 = 0;
			colontmp__153721 = nimMin(max_lag_153668, n_153678);
			var res_153724 = 1;
			L2: do {
					L3: while (true) {
					if (!(res_153724 <= colontmp__153721)) break L3;
						h_153693 = res_153724;
						var a_153706 = HEX5BHEX5D_150414(x_153667, HEX2EHEX2E_57828(0, (n_153678 - h_153693)));
						var b_153717 = HEX5BHEX5D_150414(x_153667, HEX2EHEX2E_57828(h_153693, n_153678));
						HEX5BHEX5DHEX3D_150014(result_153669[0], h_153693, ((mean_153041(HEX2EHEX2A_152156(HEX2D_152028(a_153706, u_153679), HEX2D_152028(b_153717, u_153679))) + 1.0000000000000000e-10) / ((n_153678 * s2_153680) + 1.0000000000000000e-10)));
						res_153724 += 1;
					}
			} while(false);
		} while(false);

	return result_153669[0];
...
function acf_confidence_interval_153648(x_153650) {
	var result_153651 = 0.0;

		result_153651 = (1.9600000000000000e+00 * Math.sqrt(HEX2F_19442(1, len_148780(x_153650))));

	return result_153651;

}

function acf_information_153741(x_153743, max_lag_153744) {
	var result_153745 = {autocorrelation: null, confidence_interval: 0.0};

		result_153745.autocorrelation = nimCopy(null, vector_to_seq_149538(acf_153665(x_153743, max_lag_153744)), NTI149541);
		result_153745.confidence_interval = acf_confidence_interval_153648(x_153743);

	return result_153745;

}
var x_153762 = vector_148363([3, 2, 1, 9, 4, 2, 5, 3, 3, 6, 8, 9, 10]);
var y_153763 = acf_153665(x_153762, 10);
rawEcho(makeNimstrLit("AutocorrelationFunction"));
var fmt_res_153769 = [mnewString(0)];
if (fmt_res_153769[0] != null) { fmt_res_153769[0] = (fmt_res_153769[0]).concat(makeNimstrLit("  X: ")); } else { fmt_res_153769[0] = makeNimstrLit("  X: "); };
if (fmt_res_153769[0] != null) { fmt_res_153769[0] = (fmt_res_153769[0]).concat(HEX24_148831(x_153762)); } else { fmt_res_153769[0] = HEX24_148831(x_153762).slice(); };
rawEcho(fmt_res_153769[0]);
...
if (fmt_res_153806[0] != null) { fmt_res_153806[0] = (fmt_res_153806[0]).concat(HEX24_148831(y_153763)); } else { fmt_res_153806[0] = HEX24_148831(y_153763).slice(); };
...
if (fmt_res_154006[0] != null) { fmt_res_154006[0] = (fmt_res_154006[0]).concat(HEX24_154202(acf_information_153741(x_153762, 10))); } else { fmt_res_154006[0] = HEX24_154202(acf_information_153741(x_153762, 10)).slice(); };
...
function student_t_ppf_95p_153612(df_153614) {
	var result_153615 = 0.0;

		result_153615 = student_t_ppf_95p_153554(((df_153614)|0));

	return result_153615;
...
function HEX2D_151983(v_151985, w_151986) {
	var result_151987 = [{length: 0, data: null}];
		...
		result_151987[0].data = new Float32Array(1012);
		L1: do {
			var i_152004 = 0;
...
function HEX2B_151882(v_151884, k_151885) {
	var result_151886 = [{length: 0, data: null}];
		...
		result_151886[0].data = new Float32Array(1012);
		L1: do {
			var i_151903 = 0;
...
function HEX2EHEX2A_152201(v_152203, k_152204) {
	var result_152205 = [{length: 0, data: null}];
		...
		result_152205[0].data = new Float32Array(1012);
		L1: do {
			var i_152222 = 0;
...
function HEX2EHEX5E_152682(v_152684, k_152685) {
	var result_152686 = [{length: 0, data: null}];
		...
		result_152686[0].data = new Float32Array(1012);
		L1: do {
			var i_152703 = 0;
...
function simple_linear_regression(x_161827, y_161828) {
	var result_161829 = {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0};
		...
		var t_value_161836 = student_t_ppf_95p_153612((n_161830 - 2.0000000000000000e+00));
		...
		nimCopy(result_161829.autocorrelation_function, acf_information_153741(residual_161869, 100), NTI153631);
...
function simple_linear_regression_wo_intercept(x_161923, y_161924) {
	var result_161925 = {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0};
		...
		nimCopy(result_161925.autocorrelation_function, acf_information_153741(residual_161949, 100), NTI153631);
		...
		result_161925.slope_width_confidence_interval = ((2.0000000000000000e+00 * Math.sqrt(result_161925.slope_variance)) * student_t_ppf_95p_153612((n_161926 - 1.0000000000000000e+00)));
...
function arma(x_161969, y_161970) {
	var result_161971 = {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}};

		nimCopy(result_161971.mean_structure, simple_linear_regression(x_161969, y_161970), NTI156610);
		var residuals_161972 = HEX2D_151983(y_161970, HEX2B_151927(result_161971.mean_structure.intercept, HEX2A_152320(result_161971.mean_structure.slope, x_161969)));
		nimCopy(result_161971.autoregressive_structure, simple_linear_regression_wo_intercept(HEX5BHEX5D_150414(residuals_161972, HEX2EHEX2E_57828(0, (high_148797(residuals_161972) - 1))), HEX5BHEX5D_150414(residuals_161972, HEX2EHEX2E_57828(1, high_148797(residuals_161972)))), NTI156610);

	return result_161971;
...
function HEX2DHEX3D_162022(x_162027, x_162027_Idx, y_162029) {
		x_162027[x_162027_Idx] = (x_162027[x_162027_Idx] - y_162029);
...
function normal_loglikelihood_162010(x_162012, y_162013, slope_162014, intercept_162015, sigma2_162016) {
	var result_162017 = [0.0];

		var n_162018 = len_148780(x_162012);
		result_162017[0] = ((-5.0000000000000000e-01 * n_162018) * Math.log(((6.2831853071795862e+00 * sigma2_162016) + 1.0000000000000000e-10)));
		HEX2DHEX3D_162022(result_162017, 0, (sum_152959(HEX2EHEX5E_152772(HEX2D_151983(y_162013, HEX2B_151927(intercept_162015, HEX2A_152320(slope_162014, x_162012))), 2)) / ((2.0000000000000000e+00 * sigma2_162016) + 1.0000000000000000e-10)));

	return result_162017[0];

}

function analysis_at_point_t_162058(x_162060, y_162061, change_point_162062) {
	var result_162063 = {loglikelihood: 0.0, before_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, after_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}};

		var n_162064 = len_148780(x_162060);
		var x_before_162077 = HEX5BHEX5D_150414(x_162060, HEX2EHEX2E_57828(0, (change_point_162062 - 1)));
		var y_before_162090 = HEX5BHEX5D_150414(y_162061, HEX2EHEX2E_57828(0, (change_point_162062 - 1)));
		var x_after_162101 = HEX5BHEX5D_150414(x_162060, HEX2EHEX2E_57828(change_point_162062, high_148797(x_162060)));
		var y_after_162112 = HEX5BHEX5D_150414(y_162061, HEX2EHEX2E_57828(change_point_162062, high_148797(y_162061)));
		nimCopy(result_162063.before_change, arma(x_before_162077, y_before_162090), NTI156661);
		HEX2BHEX3D_31099(result_162063, "loglikelihood", normal_loglikelihood_162010(x_before_162077, y_before_162090, result_162063.before_change.mean_structure.slope, result_162063.before_change.mean_structure.intercept, result_162063.before_change.autoregressive_structure.residual_variance));
		nimCopy(result_162063.after_change, arma(x_after_162101, y_after_162112), NTI156661);
		HEX2BHEX3D_31099(result_162063, "loglikelihood", normal_loglikelihood_162010(x_after_162101, y_after_162112, result_162063.after_change.mean_structure.slope, result_162063.after_change.mean_structure.intercept, result_162063.after_change.autoregressive_structure.residual_variance));
...
function robust_interrupted_time_series_model_162146(x_162148, y_162149, change_point_162150, candidates_before_162151, candidates_after_162152) {
								var Tmp5;

	var result_162153 = {before_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, after_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, likelihood: {change_points: null, loglikelihood: null, best_loglikelihood: 0.0, best_likelihood: 0.0, best_time: 0.0, best_index: 0}, parameter_differences: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, autoregressive_slope: 0.0, autoregressive_slope_variance: 0.0, autoregressive_slope_confidence_interval: new Float64Array(2), autoregressive_slope_width_confidence_interval: 0.0, autoregressive_slope_p_value: 0.0}};

		var ll_result_162154 = {loglikelihood: 0.0, before_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, after_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}};
		result_162153.likelihood.best_loglikelihood = -1.0000000000000000e+100;
		L1: do {
			var t_162163 = 0;
			var colontmp__162186 = 0;
			var colontmp__162187 = 0;
			colontmp__162186 = (change_point_162150 - candidates_before_162151);
			colontmp__162187 = (change_point_162150 + candidates_after_162152);
			var res_162190 = colontmp__162186;
			L2: do {
					L3: while (true) {
					if (!(res_162190 <= colontmp__162187)) break L3;
						t_162163 = res_162190;
						L4: do {
								if ((t_162163 < 3)) Tmp5 = true; else {									Tmp5 = (high_148797(x_162148) < t_162163);								}							if (Tmp5) {
							break L4;
							}
							
							nimCopy(ll_result_162154, analysis_at_point_t_162058(x_162148, y_162149, t_162163), NTI156665);
							var Tmp6 = nimCopy(null, t_162163, NTI17403);
							if (result_162153.likelihood.change_points != null) { result_162153.likelihood.change_points.push(Tmp6); } else { result_162153.likelihood.change_points = [Tmp6]; };
							var Tmp7 = nimCopy(null, ll_result_162154.loglikelihood, NTI124);
							if (result_162153.likelihood.loglikelihood != null) { result_162153.likelihood.loglikelihood.push(Tmp7); } else { result_162153.likelihood.loglikelihood = [Tmp7]; };
							if ((result_162153.likelihood.best_loglikelihood < ll_result_162154.loglikelihood)) {
							result_162153.likelihood.best_loglikelihood = ll_result_162154.loglikelihood;
							result_162153.likelihood.best_likelihood = Math.exp(ll_result_162154.loglikelihood);
							result_162153.likelihood.best_index = t_162163;
							result_162153.likelihood.best_time = HEX5BHEX5D_149595(x_162148, t_162163);
							nimCopy(result_162153.before_change, ll_result_162154.before_change, NTI156661);
							nimCopy(result_162153.after_change, ll_result_162154.after_change, NTI156661);
							nimCopy(result_162153.parameter_differences, model_differences_156719(result_162153.before_change, result_162153.after_change), NTI156635);
							}
	...
	return result_162153;

}

function robust_interrupted_time_series(x_162210, y_162212, change_point_162213, candidates_before_162214, candidates_after_162215) {
	var result_162216 = {before_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, after_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, likelihood: {change_points: null, loglikelihood: null, best_loglikelihood: 0.0, best_likelihood: 0.0, best_time: 0.0, best_index: 0}, parameter_differences: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, autoregressive_slope: 0.0, autoregressive_slope_variance: 0.0, autoregressive_slope_confidence_interval: new Float64Array(2), autoregressive_slope_width_confidence_interval: 0.0, autoregressive_slope_p_value: 0.0}};

		nimCopy(result_162216, robust_interrupted_time_series_model_162146(vector_148236(x_162210), vector_148236(y_162212), change_point_162213, candidates_before_162214, candidates_after_162215), NTI156680);
...
function vector_reduced_148689(v_148692, sampling_148693) {
	var result_148694 = {length: 0, data: null};
		...
		result_148694.data = new Float32Array(1012);
...
function robust_interrupted_time_series_approximated(sampling_162232, x_162234, y_162236, change_point_162237, candidates_before_162238, candidates_after_162239) {
	var result_162240 = {before_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, after_change: {mean_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}, autoregressive_structure: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, R2: 0.0, residual: null, residual_sum_squares: 0.0, residual_variance: 0.0, autocorrelation_function: {autocorrelation: null, confidence_interval: 0.0}, n: 0}}, likelihood: {change_points: null, loglikelihood: null, best_loglikelihood: 0.0, best_likelihood: 0.0, best_time: 0.0, best_index: 0}, parameter_differences: {intercept: 0.0, intercept_variance: 0.0, intercept_confidence_interval: new Float64Array(2), intercept_width_confidence_interval: 0.0, intercept_p_value: 0.0, slope: 0.0, slope_variance: 0.0, slope_confidence_interval: new Float64Array(2), slope_width_confidence_interval: 0.0, slope_p_value: 0.0, autoregressive_slope: 0.0, autoregressive_slope_variance: 0.0, autoregressive_slope_confidence_interval: new Float64Array(2), autoregressive_slope_width_confidence_interval: 0.0, autoregressive_slope_p_value: 0.0}};

		nimCopy(result_162240, robust_interrupted_time_series_model_162146(vector_reduced_148689(x_162234, sampling_162232), vector_reduced_148689(y_162236, sampling_162232), (((change_point_162237 / sampling_162232))|0), (((candidates_before_162238 / sampling_162232))|0), (((candidates_after_162239 / sampling_162232))|0)), NTI156680);

	return result_162240;
