riot.tag2('rts-plot-collection', '<div> <virtual if="{_anyPlotFilter()}"> <div class="{⁗graph-collection collection-⁗ + (plot.index + 1)}" each="{plot, index in opts.plots}"> <virtual if="{!plot.type.startsWith(\'combined-\')}"> <rts-model-plot type="{plot.type}" class="{plot.type}" model="{opts.models[plot.index]}" title="{plot.title}" subtitle="{plot.subtitle}"></rts-model-plot> </virtual> <virtual if="{plot.type.startsWith(\'combined-\')}"> <div class="column-before"> <rts-model-plot type="{_adjust_type(plot, \'before-\')}" class="{_adjust_type(plot, \'before-\')}" model="{opts.models[plot.index]}" title="{plot.title}" subtitle="{plot.subtitle}"></rts-model-plot> </div> <div class="column-after"> <rts-model-plot type="{_adjust_type(plot, \'after-\')}" class="{_adjust_type(plot, \'after-\')}" model="{opts.models[plot.index]}" title="{plot.title}" subtitle="{plot.subtitle}"></rts-model-plot> </div> </virtual> </div> </virtual> </div>', 'rts-plot-collection .hidden,[data-is="rts-plot-collection"] .hidden{ display: none!important; } rts-plot-collection .graph-collection rts-model-plot > div,[data-is="rts-plot-collection"] .graph-collection rts-model-plot > div{ border: none!important; box-shadow: none!important; } rts-plot-collection .graph-collection rts-model-plot,[data-is="rts-plot-collection"] .graph-collection rts-model-plot{ margin-top:10px; margin-bottom: 20px; } rts-plot-collection .column-after,[data-is="rts-plot-collection"] .column-after,rts-plot-collection .column-before,[data-is="rts-plot-collection"] .column-before{ width: 45%; margin-left: 2.5%; margin-right: 2.5%; display: table-cell; }', '', function(opts) {
