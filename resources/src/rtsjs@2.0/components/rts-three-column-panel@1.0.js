...
self.update_models = (model) => {
      self.model = model;
      const up = (c) => {self.refs[c].opts.model = model; self.refs[c].update(); };
      up("plain");
      up("loglikelihood");
