...
var Utils = {
    ...
    isTouchDevice: function() {
        return false; //MARCO: Issue with events in Electron in touch devices!
    ...
    isOutsider: function(el) {
        ...
        return (
            ...
            rect.right <= (window.outerHeight || document.documentElement.clientWidth)
        );
    },
...
var Spinner = {
    ...
    _createEvents: function(){
        ...
        spinner_buttons.on(Metro.events.click, function(e){
            e.preventDefault();
            that.repeat_timer = !true;
            spinnerButtonClick($(this).hasClass("spinner-button-plus"), o.repeatThreshold);
            e.stopPropagation();
