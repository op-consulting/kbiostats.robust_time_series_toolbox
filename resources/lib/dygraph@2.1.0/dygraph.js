(function (f) {
  ...
  return (function e(t, n, r) {
    ...
    16: [function (require, module, exports) {
      ...
      TICK_PLACEMENT[Granularity.DOUBLEANNUAL] = {
        datefield: DateField.DATEFIELD_Y,
        step: 2,
        spacing: 1000 * 86400 * 365.2524 * 2
      }; // 1e3 * 60 * 60 * 24 * 365.2524 * 10
      TICK_PLACEMENT[Granularity.FIFTHANNUAL] = {
        datefield: DateField.DATEFIELD_Y,
        step: 5,
        spacing: 1000 * 86400 * 365.2524 * 5
      }; // 1e3 * 60 * 60 * 24 * 365.2524 * 10
    ...
    17: [function (require, module, exports) {
      ...
      function dateAxisLabelFormatter(date, granularity, opts) {
        ...
        if (granularity >= DygraphTickers.Granularity.DECADAL) {
          return '' + year;
        } else if (granularity >= DygraphTickers.Granularity.ANNUAL) {
          return year;
      ...
      (function (process) {
        ...
        */
        ...
        Dygraph.prototype.__init__ = function (div, file, attrs) {
          ...
          for (var i = 0; i < plugins.length; i++) { // the plugins option may contain either plugin classes or instances.
        ...
        Dygraph.prototype.xAxisExtremes = function () {
          ...
          if (pad) { // Must keep this in sync with dygraph-layout _evaluateLimits()
        ...
        Dygraph.prototype.toDataYCoord = function (y, axis) {
          ...
          } else { // Computing the inverse of toDomCoord.
        ...
        Dygraph.prototype.toPercentYCoord = function (y, axis) {
          ...
          } else { // yRange[1] - y is unit distance from the bottom.
        ...
        Dygraph.prototype.createInterface_ = function () { // Create the all-enclosing graph div
          ...
          this.mouseOutHandler_ = function (e) { // The mouse has left the chart if:
        ...
        Dygraph.prototype.setColors_ = function () {
          ...
          for (var i = 0; i < num; i++) {
            ...
            if (!colorStr) {
              ...
              } else { // alternate colors for high contrast.
        ...
        Dygraph.prototype.findStackedPoint = function (domX, domY) {
          ...
          for (var setIdx = 0; setIdx < this.layout_.points.length; ++setIdx) {
            ...
            var py = p1.canvasy;
            if (domX > p1.canvasx && rowIdx + 1 < points.length) { // interpolate series Y value using next point
        ...
        Dygraph.prototype.animateSelection_ = function (direction) {
          ...
          var that = this;
          var cleanupIfClearing = function cleanupIfClearing() { // if we haven't reached fadeLevel 0 in the max frame time,
        ...
        Dygraph.prototype.updateSelection_ = function (opt_animFraction) {
          ...
          if (this.getOption('highlightSeriesOpts')) {
            ...
            if (alpha) { // Activating background fade includes an animation effect for a gradual
        ...
        Dygraph.prototype.addXTicks_ = function () { // Determine the correct ticks scale on the x-axis: quarterly, monthly, ...
          ...
          var xTicks = xAxisOptionsView('ticker')(range[0], range[1], this.plotter_.width || 0, // TODO(danvk): should be area.width
        ...
        Dygraph.stackPoints_ = function (points, cumulativeYval, seriesExtremes, fillMethod) {
          ...
          for (var i = 0; i < points.length; ++i) {
            ...
            if (isNaN(actualYval) || actualYval === null) {
              if (fillMethod == 'none') {
                actualYval = 0;
              } else { // Interpolate/extend for stacking purposes if possible.
                updateNextPoint(i);
                if (prevPoint && nextPoint && fillMethod != 'none') { // Use linear interpolation between prevPoint and nextPoint.
            ...
            if (lastXval != xval) { // If an x-value is repeated, we ignore the duplicates.
        ...
        Dygraph.prototype.renderGraph_ = function (is_initial_draw) {
          ...
          if (underlayCallback) { // NOTE: we pass the dygraph object to this callback twice to avoid breaking
        ...
        Dygraph.prototype.computeYAxes_ = function () {
          ...
          this.axes_ = [];
          for (axis = 0; axis < this.attributes_.numAxes(); axis++) { // Add a new axis, making a copy of its per-axis options.
            opts = {
              g: this
            };
        ...
        Dygraph.prototype.computeYAxisRanges_ = function (extremes) {
          ...
          for (var i = 0; i < numAxes; i++) {
            ...
            if (series.length === 0) { // If no series are defined or visible then use a reasonable default
              ...
              for (var j = 0; j < series.length; j++) { // this skips invisible series
              ...
              if (span === 0) {
                if (maxY !== 0) {
                  span = Math.abs(maxY);
                } else { // ... and if the sole value is zero, use range 0-1.
                  maxY = 1;
                  span = 1;
                }
              }
            ...
            if (!ypadCompat) { // When using yRangePad, adjust the upper/lower bounds to add
        ...
        Dygraph.prototype.detectTypeFromString_ = function (str) {
          ...
          if (dashPos > 0 && str[dashPos - 1] != 'e' && str[dashPos - 1] != 'E' || str.indexOf('/') >= 0 || isNaN(parseFloat(str))) {
            isDate = true;
          } else if (str.length == 8 && str > '19700101' && str < '20371231') { // TODO(danvk): remove support for this format.
            isDate = true;
          }
        ...
        Dygraph.prototype.parseCSV_ = function (data) {
          ...
          var start = 0;
          if (!('labels' in this.user_attrs_)) { // User hasn't explicitly set labels, so they're (presumably) in the CSV.
            start = 1;
        ...
        Dygraph.prototype.parseDataTable_ = function (data) {
          ...
          for (i = 1; i < cols; i++) {
            ...
            if (type == 'number') {
              colIdx.push(i);
            } else if (type == 'string' && this.getBooleanOption('displayAnnotations')) { // This is OK -- it's an annotation column.
        ...
        Dygraph.prototype.start_ = function () {
          ...
          if (utils.isArrayLike(data)) {
            ...
            this.cascadeDataDidUpdateEvent_();
            this.predraw_();
          } else if (typeof data == 'object' && typeof data.getColumnRange == 'function') { // must be a DataTable from gviz.
        ...
        Dygraph.prototype.updateOptions = function (input_attrs, block_redraw) {
          ...
          this.attributes_.reparseSeries();
          if (file) { // This event indicates that the data is about to change, but hasn't yet.
        ...
        Dygraph.prototype.resize = function (width, height) {
          ...
          if (old_width != this.width_ || old_height != this.height_) { // Resizing a canvas erases it, even when the size doesn't change, so
