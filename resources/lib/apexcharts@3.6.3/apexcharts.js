    ...
    _createClass(Line, [{
      ...
      value: function createPaths(_ref) {
        var series = _ref.series,
            seriesIndex = _ref.seriesIndex, //MINE!
            i = _ref.i,
            j = _ref.j,
            x = _ref.x,
            y = _ref.y,
        ...
        var curve = Array.isArray(w.config.stroke.curve) ? w.config.stroke.curve[seriesIndex] : w.config.stroke.curve; //MINE!
  ...
  function () {
    ...
    _createClass(Position, [{
      ...
      value: function moveDynamicPointOnHover(j, capturedSeries) {
        ...
        try{pointsArr[capturedSeries][j][0]}catch(e){return;}//MINE!
